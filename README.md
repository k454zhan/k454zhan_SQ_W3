...
| File                               | Source                                              |
| ---------------------------------- | --------------------------------------------------- |
| `assets/sounds/energypunch.mp3`    | Short Energy Beam Shot (4) — pixabay.com            |
| `assets/sounds/victory.mp3`        | Victory tune — Pixabay.com                          |
| `assets/sounds/new_background.mp3` | Atmospheric Mysterious Ambiance Music — Pixabay.com |
| `portal.jpg`                       | A Yellow Round Light and Light — Pexels.com         |
...
[4] TheoJT. 2023. Atmospheric Mysterious Ambiance Music [Music]. Pixabay. Retrieved August 7, 2026 from https://pixabay.com/music/ambient-atmospheric-mysterious-ambiance-music-131952/
